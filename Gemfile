...
group :development do
  if RUBY_VERSION < '1.9'
    ...
    gem 'ruby-debug19' # gem install ruby-debug19 -- --with-ruby-include=/Users/pasha/.rvm/src/ruby-1.9.2-head/
  end
  gem 'jeweler'
  gem 'awesome_print'
  gem 'wirble'
...
gem 'devise', '~> 1.1.1'
gem 'cancan', '~> 1.3.3'
gem 'formtastic', :git => 'git://github.com/justinfrench/formtastic.git', :branch => 'rails3' #, '~> 1.0.1'
...
# gem 'aws'
# gem 'ckeditor', :git => 'git://github.com/chipiga/rails-ckeditor.git', :branch => 'rails3' #, :path => '~/code/rails-ckeditor'
# gem 'refraction'
# gem 'htmlentities'
